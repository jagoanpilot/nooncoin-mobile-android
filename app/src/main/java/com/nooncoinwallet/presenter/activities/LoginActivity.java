...
import com.noonplatform.APIClient;
import com.google.firebase.analytics.FirebaseAnalytics;


import java.util.List;

import static com.nooncoinwallet.R.color.white;
import static com.nooncoinwallet.tools.util.BRConstants.PLATFORM_ON;
import static com.nooncoinwallet.tools.util.BRConstants.SCANNER_REQUEST;
...
//                chooseWordsSize(true);
                ...
                public void onClick(View v) {
                    AuthManager.getInstance().authPrompt(LoginActivity.this, "", "", false, true, new BRAuthCompletion() {
                        ...
                        public void onComplete() {
                            ...
                            NooncoinApp.getFirebaseInstance().logEvent(FirebaseAnalytics.Event.LOGIN,params);
                            unlockWallet();
                        }
        ...
        NooncoinApp.addOnBackgroundedListener(new NooncoinApp.OnAppBackgrounded() {
            @Override
